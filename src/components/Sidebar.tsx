...
const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { title: "ربحية المنتجات", path: "/product-profitability" },
      { title: "الأداء التشغيلي", path: "/operational-performance" },
      { title: "دوران المخزون", path: "/inventory-turnover" },
      { title: "الإيرادات حسب الفئة", path: "/revenue-by-category" },
