...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      approval_history: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "approval_history_step_id_fkey"
            columns: ["step_id"]
            isOneToOne: false
      ...
      approval_steps: {
        ...
        Relationships: [
          {
            foreignKeyName: "approval_steps_warehouse_id_fkey"
      ...
      campaign_customers: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["customer_id"]
            isOneToOne: false
            referencedRelation: "customers_cashier_limited"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "campaign_customers_customer_id_fkey"
          ...
          },
          {
            ...
            columns: ["customer_id"]
            isOneToOne: false
            referencedRelation: "customers_pos_minimal"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "campaign_customers_customer_id_fkey"
          ...
          },
          {
            ...
            columns: ["customer_id"]
            isOneToOne: false
            referencedRelation: "v_customer_pending_receipts"
      ...
      grn_items: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "grn_items_pr_item_id_fkey"
            columns: ["pr_item_id"]
            isOneToOne: false
      ...
      pr_items: {
        Row: {
          created_at: string | null
          estimated_unit_cost_bc: number | null
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "pr_items_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "inventory_summary_view"
            referencedColumns: ["product_id"]
          ...
          {
            foreignKeyName: "pr_items_uom_id_fkey"
            columns: ["uom_id"]
            isOneToOne: false
            referencedRelation: "uoms"
            referencedColumns: ["id"]
      ...
      purchase_invoices: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "purchase_invoices_pr_id_fkey"
            columns: ["pr_id"]
            isOneToOne: false
            referencedRelation: "purchase_requisitions"
            referencedColumns: ["id"]
      ...
      purchase_requisitions: {
        Row: {
          ...
          currency_code: string | null
          department: string | null
          discount_bc: number | null
          discount_fc: number | null
          exchange_rate: number | null
          id: string
          notes: string | null
          pr_number: string
        ...
        Relationships: [
          {
            foreignKeyName: "purchase_requisitions_currency_code_fkey"
            columns: ["currency_code"]
            isOneToOne: false
            referencedRelation: "currencies"
            referencedColumns: ["code"]
      ...
      receipt_collections: {
        ...
        Relationships: [
          {
            foreignKeyName: "receipt_collections_receipt_id_fkey"
            columns: ["receipt_id"]
            isOneToOne: false
            referencedRelation: "cash_receipts"
            referencedColumns: ["id"]
      ...
      rfq_quote_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "rfq_quote_items_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "inventory_summary_view"
            referencedColumns: ["product_id"]
          ...
          {
            foreignKeyName: "rfq_quote_items_uom_id_fkey"
            columns: ["uom_id"]
            isOneToOne: false
            referencedRelation: "uoms"
            referencedColumns: ["id"]
      ...
      rfq_quotes: {
        ...
        Relationships: [
          {
            foreignKeyName: "rfq_quotes_currency_code_fkey"
            columns: ["currency_code"]
            isOneToOne: false
            referencedRelation: "currencies"
            referencedColumns: ["code"]
      ...
      rfq_requests: {
        ...
        Relationships: [
          {
            foreignKeyName: "rfq_requests_currency_code_fkey"
            columns: ["currency_code"]
            isOneToOne: false
            referencedRelation: "currencies"
            referencedColumns: ["code"]
          ...
          {
            foreignKeyName: "rfq_requests_warehouse_id_fkey"
            columns: ["warehouse_id"]
            isOneToOne: false
            referencedRelation: "inventory_summary_view"
            referencedColumns: ["warehouse_id"]
    ...
    Views: {
      ...
      v_customer_pending_receipts: {
        Row: {
          credit_limit: number | null
          customer_id: string | null
          customer_name: string | null
          exceeds_credit_limit: boolean | null
          exceeds_pending_limit: boolean | null
          open_invoices_balance: number | null
          pending_receipts_limit: number | null
          remaining_receipts_balance: number | null
      ...
      v_product_selector: {
        Row: {
          ...
          scientific_material_id: string | null
          scientific_material_name: string | null
          scientific_material_name_en: string | null
          sellable: boolean | null
          sku: string | null
      ...
      v_products_with_scientific_materials: {
        Row: {
          barcode: string | null
          category_name: string | null
          cost_price: number | null
          ...
          scientific_material_active: boolean | null
          scientific_material_id: string | null
          scientific_material_name: string | null
          scientific_material_name_en: string | null
          sku: string | null
    ...
    Functions: {
      ...
      approve_approval_step: {
        Args: { p_comments?: string; p_request_id: string }
        Returns: Json
      }
      ...
      can_manage_product_status: { Args: { user_id: string }; Returns: boolean }
      check_credit_limit: {
        Args: { p_amount: number; p_customer_id: string }
        Returns: Json
      }
      check_customer_pending_receipts_warning: {
      ...
      convert_pr_to_rfq: { Args: { p_pr_id: string }; Returns: Json }
      convert_quote_to_po: { Args: { p_quote_id: string }; Returns: Json }
      ...
      decrypt_national_id: { Args: { p_employee_id: string }; Returns: string }
      ...
      lock_stock_for_pr: { Args: { p_pr_id: string }; Returns: Json }
