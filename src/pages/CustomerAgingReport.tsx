...
import { getCustomerAging, CustomerAgingRow } from "@/lib/accounting";
...
const CustomerAgingReport = () => {
  ...
  const {
    ...
    queryFn: () => getCustomerAging(asOfDate),
    enabled: canView,
  });
  ...
  const exportToCSV = () => {
    ...
    link.download = `تقرير_أعمار_ديون_العملاء_${asOfDate}.csv`;
    link.click();
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            <CardTitle className="flex items-center gap-2">
              ...
              تقرير أعمار ديون العملاء (AR Aging)
            </CardTitle>
