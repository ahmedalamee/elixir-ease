...
-- Recreate post_purchase_invoice with security fix
...
-- Recreate post_goods_receipt with security fix
...
-- Recreate trigger function with security fix
DROP FUNCTION IF EXISTS update_po_status_on_grn() CASCADE;
