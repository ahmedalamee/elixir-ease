-- تصحيح دالة post_sales_invoice لاستخدام القيمة الصحيحة في document_type
-- المشكلة: كانت الدالة تستخدم 'SALES_INVOICE' بحروف كبيرة 
-- بينما check constraint يتوقع 'sales_invoice' بحروف صغيرة
...
-- تصحيح دالة generate_si_number أيضاً
